...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_T_TRUE = 11,                    /* T_TRUE  */
  YYSYMBOL_T_FALSE = 12,                   /* T_FALSE  */
...
static const char *const yytname[] =
{
  ...
  "LBRACKET", "RBRACKET", "COLON", "COMMA", "STRING_LIT", "NUMBER",
  "T_TRUE", "T_FALSE", "T_NULL", "$accept", "json", "value", "object",
...
yyreduce:
  ...
  case 2: /* json: value  */
#line 62 "parser.y"
                                { ast_root = (yyvsp[0].node); (yyval.node) = (yyvsp[0].node); }
...
#line 1120 "parser.tab.c"
  ...
  case 5: /* value: STRING_LIT  */
#line 68 "parser.y"
                                { (yyval.node) = ast_new_string((yyvsp[0].string_val)); free((yyvsp[0].string_val)); }
#line 1126 "parser.tab.c"
    break;

  case 6: /* value: NUMBER  */
#line 69 "parser.y"
                                { (yyval.node) = ast_new_number((yyvsp[0].number_val)); }
...
#line 1180 "parser.tab.c"
  ...
  case 14: /* pair: STRING_LIT COLON value  */
#line 92 "parser.y"
                                { (yyval.node) = ast_new_pair((yyvsp[-2].string_val), (yyvsp[0].node)); free((yyvsp[-2].string_val)); }
#line 1186 "parser.tab.c"
    break;

  case 15: /* array: LBRACKET RBRACKET  */
#line 96 "parser.y"
                                { (yyval.node) = ast_new_array(); }
